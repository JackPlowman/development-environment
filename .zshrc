...
alias env="bash ~/development-configuration/scripts/use_branch_environment_variables.sh"
alias load_env="bash ~/development-configuration/scripts/use_branch_environment_variables.sh"
alias new_env="bash ~/development-configuration/scripts/new_env.sh"
